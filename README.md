...
- [Refactor release workflow for better tagging and changelog](https://github.com/vanam-san/resume-bragdoc-template/pull/4) on [vanam-san/resume-bragdoc-template](https://github.com/vanam-san/resume-bragdoc-template) (today)
- [feat: add bold highlights and hide empty fields, update README](https://github.com/vanam-san/resume-bragdoc-template/pull/3) on [vanam-san/resume-bragdoc-template](https://github.com/vanam-san/resume-bragdoc-template) (today)
- [Revise README for public template and simplify code comments](https://github.com/vanam-san/resume-bragdoc-template/pull/2) on [vanam-san/resume-bragdoc-template](https://github.com/vanam-san/resume-bragdoc-template) (6 days ago)
